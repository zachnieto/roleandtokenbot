...
class Token(commands.Cog):
    ...
    async def link_token(self, inter: "Interaction", api_token: str):
    ...
    async def token(self, inter: "ApplicationCommandInteraction", api_token: str):
        ...
        """
        await self.link_token(inter, api_token)
